...
public interface WebSocketListener {
	 ...
	 * @param draft
	 *            The protocol draft the main.client uses to connect
	 * @param request
	 *            The opening http message send by the main.client. Can be used to access additional fields like cookies.
	...
	/**
	 * Called on the main.client side when the socket connection is first established, and the WebSocketImpl
	 ...
	 * @throws org.java_websocket.exceptions.InvalidDataException
	 *             Allows the main.client to reject the connection with the server in respect of its handshake response.
	 */
	 ...
	 * @throws org.java_websocket.exceptions.InvalidDataException
	 *             Allows the main.client to stop the connection from progressing
	 */
	...
	/**
	 * Gets the XML string that should be returned if a main.client requests a Flash
	 * security policy.
