...
/**
 * Represents one end (main.client or server) of a single WebSocketImpl connection.
...
public class WebSocketImpl implements WebSocket {
	...
	/**
	 * Queue of buffers that need to be sent to the main.client.
	 */
	...
	/**
	 * crates a websocket with main.client role
	 * 
	 * @param socket
	 *            may be unbound
	 */
	...
	public void startHandshake( ClientHandshakeBuilder handshakedata ) throws InvalidHandshakeException {
		...
		try {
			...
			// Stop if the main.client code throws an exception
			throw new InvalidHandshakeException( "Handshake data rejected by main.client." );
		} catch ( RuntimeException e ) {
			wsl.onWebsocketError( this, e );
